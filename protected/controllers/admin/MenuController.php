...
class MenuController extends CmsAdminController
{
    ...
    {
        return array(
            array('label'=>Yii::t('core/admin', 'Manage menu'), 'url'=>array('index')),
        );
    }
    ...
    {
        return array(
            array('label'=>Yii::t('core/admin', 'Add menu'), 'url'=>array('create')),
            array('label'=>Yii::t('core/admin', 'Add menu item'), 'url'=>array('createItem')),
        );
    }
